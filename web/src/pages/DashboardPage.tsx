  ...
  if (!hasFamily) {
    return (
      <div className="max-w-2xl mx-auto text-center py-8 sm:py-12 px-4">
        <h1 className="text-xl sm:text-2xl font-bold text-primary-700 mb-4">
          Welcome to Expenses Manager
        </h1>
        <p className="text-primary-500 mb-6 sm:mb-8">
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-primary-700">Dashboard</h1>
          <p className="text-primary-500 mt-1 text-sm sm:text-base">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="card">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-primary-700 mt-2">
        ...
        <div className="card">
          <p className="text-sm font-medium text-primary-500">This Month</p>
          <p className="text-2xl sm:text-3xl font-bold text-primary-700 mt-2">
            {formatCurrency(
        ...
        <div className="card sm:col-span-2 lg:col-span-1">
          <p className="text-sm font-medium text-primary-500">Top Category</p>
          <p className="text-2xl sm:text-3xl font-bold text-primary-700 mt-2 truncate">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        {/* Monthly trend */}
        <div className="card">
          <h2 className="text-base sm:text-lg font-semibold text-primary-700 mb-4">
            Monthly Spending
          </h2>
          {monthlyChartData.length > 0 ? (
            <div className="h-56 sm:h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={monthlyChartData} margin={{ left: -10, right: 10 }}>
                  ...
                  <XAxis dataKey="month" tick={{ fontSize: 12, fill: '#547792' }} />
                  <YAxis tick={{ fontSize: 12, fill: '#547792' }} />
                  <Tooltip
            ...
            <div className="h-56 sm:h-64 flex items-center justify-center text-primary-400">
              No data available
            </div>
          )}
        </div>
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-base sm:text-lg font-semibold text-primary-700">
            Recent Expenses
          </h2>
          <Link
            to="/expenses"
          ...
          <div className="divide-y divide-cream-200 -mx-4 sm:-mx-6 px-4 sm:px-6">
            {summary.recent_expenses.map((expense) => (
              ...
              >
                ...
                <p className="font-semibold text-primary-700 flex-shrink-0">
