  ...
  if (!user?.family_id) {
    return (
      <div className="text-center py-12 px-4">
        ...
        <Link to="/family" className="btn-primary mt-4 inline-block">
          Set up family
        </Link>
      </div>
    );
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Link to="/expenses/new" className="btn-primary flex-1 sm:flex-none text-center">
            + Add
          </Link>
        </div>
      </div>
                    ...
                    <tr key={expense.id} className="hover:bg-gray-50">
                      <td className="px-4 lg:px-6 py-4">
                        <div>
                          ...
                          {expense.place && (
                            <p className="text-sm text-gray-500 truncate max-w-[200px]">{expense.place}</p>
                          )}
