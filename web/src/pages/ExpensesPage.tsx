  ...
  if (!user?.family_id) {
    return (
      <div className="text-center py-12 px-4">
        <p className="text-primary-500 dark:text-cream-300">
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h1 className="text-xl sm:text-2xl font-bold text-primary-700 dark:text-cream-100">Expenses</h1>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          <p className="text-red-600 dark:text-red-400">Failed to load expenses.</p>
        </div>
      ) : data?.expenses.length === 0 ? (
        <div className="card text-center py-12">
          <p className="text-primary-400 dark:text-cream-400">No expenses found.</p>
          <Link
            to="/expenses/new"
              ...
              <div key={expense.id} className="card p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-sm text-primary-500 dark:text-cream-300">{expense.category}</p>
                  ...
                  <p className="font-semibold text-primary-700 dark:text-cream-100 text-lg">
                ...
                <tbody className="divide-y divide-cream-200 dark:divide-primary-700">
                  {data?.expenses.map((expense) => (
                    <tr key={expense.id} className="hover:bg-cream-50 dark:hover:bg-primary-700/50">
                      ...
                      <td className="px-4 lg:px-6 py-4 whitespace-nowrap text-right font-semibold text-primary-700 dark:text-cream-100">
                        {formatCurrency(expense.amount)}
                      </td>
